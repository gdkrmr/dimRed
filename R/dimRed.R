...
#'
#' @description
#' This package simplifies dimensionality reduction in R by providing
#' a framework in form of S4 classes and methods. dimRed collects
#' dimensionality reduction methods that are implemented in R and
...
#' 92–108. doi:10.1016/j.neucom.2012.12.036
#'
